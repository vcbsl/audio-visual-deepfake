...
def contextual_attention_model(mode):
    ...
    ## Multi Modal Uni Utterance Self Attention ##
        ...
        for k in range(max_utt_len):
            ...
            utterance_features = concatenate([m1, m3], axis=1)
        ...
        merged = concatenate([merged_attention, dense_video, dense_text])
    ...
    ## Multi Utterance Self Attention ##
        ...
        merged = concatenate([vv_att, tt_att, dense_video, dense_text])
            
        
    ## No Attention ##    
    elif mode == 'None':
            
        merged = concatenate([dense_video, dense_text])
    ...
    model = Model([in_text, in_video], output)        
